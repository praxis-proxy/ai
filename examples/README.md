...
| [trace-context.yaml](configs/trace-context.yaml) | Propagates x-request-id and W3C traceparent across every leg of an AI request, so a single request is traceable end to end |
