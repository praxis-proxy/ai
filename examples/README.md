...
| [agentic-loop.yaml](configs/openai/responses/agentic-loop.yaml) | Demonstrates the agentic_loop filter that manages the inference loop lifecycle for the Responses API |
