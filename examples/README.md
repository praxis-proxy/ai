...
| File | Description |
| ------ | ------------- |
| [full-flow-agentic.yaml](configs/anthropic/full-flow-agentic.yaml) | Runs a non-streaming native Messages model -> You.com search -> model loop through Praxis core's iterative_request_router |
