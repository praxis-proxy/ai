...
| [llmd-ext-proc-routing.yaml](configs/llmd-ext-proc-routing.yaml) | Routes through the llm-d ext_proc compatibility filter and selects the trusted backend endpoint returned by the processor |
