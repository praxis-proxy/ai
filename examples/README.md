...
| [responses-to-chat-completions-conformance.yaml](configs/openai/responses/responses-to-chat-completions-conformance.yaml) | Minimal Responses-to-Chat-Completions translation chain used by the external OpenResponses conformance suite to validate the translator in isolation |
