...
- **`openai_file_search_dispatch`** — Executes pending file search calls against a vector store API compatible backend.
...
| `openai_file_search_dispatch` | ✓ | ReadOnly / StreamBuffer | — | ReadWrite / Stream |
...
| `openai_web_search_dispatch` | — | ReadOnly / StreamBuffer | — | ReadOnly / Stream |
