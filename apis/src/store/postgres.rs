...
use super::{
    ...
    schemas::{
        ColumnCheck, SCHEMA_VERSION, SqlDialect, TableNames, VERSION_COLUMNS, check_column_presence,
        expected_table_columns, generate_ddl, schema_version_table, validate_postgres_identifiers,
    },
...
impl PostgresResponseStore {
    ...
    #[expect(
        ...
        reason = "constructor mirrors SqliteResponseStore::new with SSL, pool, and compression additions"
    )]
    pub async fn new(
        database_url: &str,
        responses_table: &str,
