...
/// Top-level routing overlay document as rendered by the configuration producer.
///
/// Serialised as JSON under the routing overlay key of the
/// `ConfigMap`.
#[derive(Debug, Deserialize)]
...
pub(crate) struct OverlayCandidate {
    /// Operator admission state string.
    #[serde(default)]
    ...
    ///
    /// Deserialized for type compatibility; **not used** by `intelligent_route`.
    /// The `credential_inject` filter (PR #386) consumes this field.
    #[serde(default)]
    #[expect(
        clippy::allow_attributes,
        reason = "dead_code fires only in lib, not in test; expect would be unfulfilled in test"
    )]
    #[allow(dead_code, reason = "type compatibility with routing overlay")]
    ...
    /// Operator rank within the overlay (lower is better).
    #[serde(default)]
    pub(crate) rank: Option<u32>,

    /// Operator locality tier (e.g. `"same_region"`).
    #[serde(default)]
...
#[derive(Debug, Deserialize)]
#[serde(deny_unknown_fields)]
#[expect(dead_code, reason = "type compatibility with routing overlay")]
...
/// Apply operator metadata to validated candidates.
///
...
mod tests {
    ...
    #[test]
    fn snapshot_from_producer_overlay() {
        let json = r#"{
    ...
    fn zero_source_generation_rejected() {
        ...
        let result = RouteSnapshot::from_overlay(serde_json::to_string(&value).unwrap().as_bytes());
        assert!(result.is_err(), "zero source_generation must be rejected");
    }
    ...
    #[test]
    fn routing_fixture_valid_minimal() {
    ...
    #[test]
    fn routing_fixture_valid_multi_candidate() {
    ...
    #[test]
    fn routing_fixture_legacy_payload() {
    ...
    #[test]
    fn routing_fixture_unsupported_schema_version() {
    ...
    #[test]
    fn routing_fixture_invalid_digest() {
    ...
    #[test]
    fn routing_fixture_revision_digest_disagreement() {
    ...
    #[test]
    fn routing_fixture_timestamp_change_same_revision() {
    ...
    #[test]
    fn routing_fixture_unknown_additive_field() {
    ...
    #[test]
    fn routing_fixture_network_scope_mismatch() {
    ...
    #[test]
    fn routing_fixture_local_site_scope_mismatch() {
    ...
    #[test]
    fn routing_fixture_malformed_envelope() {
    ...
    #[test]
    fn routing_fixture_hybrid_missing_schema() {
    ...
    #[test]
    fn routing_fixture_credential_ref_no_secret_value() {
        let fixture = include_bytes!("../../../tests/fixtures/overlay-contract/v1/valid-multi-candidate.json");
    ...
    fn routing_fixture_manifest_complete() {
