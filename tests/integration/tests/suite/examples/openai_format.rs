...
#[test]
fn openai_format_routing_example_routes_responses_input() {
    let h = start();
...
#[test]
fn openai_format_routing_example_routes_chat_completions() {
    let h = start();
...
#[test]
fn openai_format_routing_example_chat_identity_ignores_the_body() {
    let h = start();
...
#[test]
fn openai_format_routing_example_unsupported_chat_method_falls_to_default() {
    let h = start();
...
#[test]
fn openai_format_routing_example_unknown_falls_to_default() {
    let h = start();
