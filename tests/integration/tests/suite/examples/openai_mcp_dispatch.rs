...
//! Functional tests for the mcp-dispatch example config.
...
#[test]
fn openai_mcp_dispatch_example_passes_through_non_mcp_request() {
...
#[test]
fn openai_mcp_dispatch_example_passes_through_function_tools() {
    let backend_guard = start_backend_with_shutdown("inference");
    let proxy_port = free_port();
...
#[test]
fn openai_mcp_dispatch_example_rejects_ssrf_mcp_url() {
    let backend_guard = start_backend_with_shutdown("inference");
    let proxy_port = free_port();
